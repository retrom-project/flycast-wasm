...
emmake make -C "$EJS_RA" -f Makefile.emulatorjs -f /work/.github/rpg-runtime/objects.mk   retrom-objects HAVE_CHD=0 HAVE_THREADS=0 PTHREAD_POOL_SIZE=0 ASYNC=1 HAVE_OPENGLES3=1   HAVE_AL=1 HAVE_RWEBAUDIO=0 -j8
